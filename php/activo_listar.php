<?php
    ...
    piso.piso_numero,posicion.posicion_id,posicion.posicion_posicion,area.area_id,area.area_nombre,sector.sector_id,sector.sector_nombre,estadoactivo.estadoactivo_id,estadoactivo.estadoactivo_nombre";
	...
	if(isset($busqueda) && $busqueda!=""){
                ...
                INNER JOIN area On activo.area_id=area.area_id INNER JOIN sector ON activo.sector_id=sector.sector_id INNER JOIN estadoactivo On activo.estadoactivo_id=estadoactivo.estadoactivo_id where activo.activo_codigo Like '$busqueda%' Or activo.activo_marca Like '%$busqueda%' Or activo.activo_modelo Like '%$busqueda%' 
				...
				$consulta_datos="SELECT $campos FROM activo INNER JOIN categoria ON activo.categoria_id=categoria.categoria_id INNER JOIN piso On activo.piso_id=piso.piso_id INNER JOIN posicion On activo.posicion_id=posicion.posicion_id
                INNER JOIN area On activo.area_id=area.area_id INNER JOIN sector ON activo.sector_id=sector.sector_id INNER JOIN estadoactivo ON activo.estadoactivo_id=estadoactivo.estadoactivo_id WHERE activo.categoria_id='$categoria_id' ORDER BY activo.activo_codigo ASC LIMIT $inicio,$registros";
				...
				$consulta_datos="SELECT $campos FROM activo INNER JOIN categoria ON activo.categoria_id=categoria.categoria_id INNER JOIN piso On activo.piso_id=piso.piso_id INNER JOIN posicion On activo.posicion_id=posicion.posicion_id
                INNER JOIN area On activo.area_id=area.area_id INNER JOIN sector ON activo.sector_id=sector.sector_id INNER JOIN estadoactivo ON activo.estadoactivo_id=estadoactivo.estadoactivo_id WHERE activo.estadoactivo_id='$estadoactivo_id' ORDER BY activo.activo_codigo ASC LIMIT $inicio,$registros";
		...
		$consulta_datos="SELECT $campos FROM activo Inner Join categoria On activo.categoria_id=categoria.categoria_id INNER JOIN piso On activo.piso_id=piso.piso_id INNER JOIN posicion On activo.posicion_id=posicion.posicion_id
                INNER JOIN area On activo.area_id=area.area_id INNER JOIN sector ON activo.sector_id=sector.sector_id INNER JOIN estadoactivo ON activo.estadoactivo_id=estadoactivo.estadoactivo_id Order By activo.activo_codigo Asc Limit $inicio,$registros";
