			...
			<div class="columns">
				<div class="column">
					<div class="field">
						...
						<textarea class="textarea is-small" type="text" name="activo_comentario" placeholder="Agregue su comentario por la modificación del activo" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{2,300}" maxlength="300" require value="<?php echo $datos['activo_comentario']; ?>"></textarea>
					</div>
				</div>

				<div class="column">
					<label>Solo cargar por baja de activo</label>
					<div class="file has-name">
						<div class="file is-primary">
							<div id="file-js-example" class="file has-name">
								<label class="file-label">
									<input class="file-input" type="" name="activo_documento" />
									<span class="file-cta">
